...
export class aclRefactor1669719832582 implements MigrationInterface {
  name = 'aclRefactor1669719832582';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "user" ADD "roles" "public"."AccessRole" NOT NULL DEFAULT ''`);
