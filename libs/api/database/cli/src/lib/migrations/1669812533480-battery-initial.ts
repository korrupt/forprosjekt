...
export class batteryInitial1669812533480 implements MigrationInterface {
  name = 'batteryInitial1669812533480';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TYPE "public"."Permissions" AS ENUM('CREATE', 'READ', 'UPDATE', 'MANAGE')`);
    await queryRunner.query(
      `CREATE TABLE "user_battery" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "ownerId" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "batteryId" uuid NOT NULL, "userId" uuid NOT NULL, "permissions" "public"."Permissions" array NOT NULL DEFAULT '{}', CONSTRAINT "PK_6b30e135669f9cc04c1c4782b56" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "public"."Permissions"`);
